...
<div>
<div class="container-fluid text-center" ng-controller="MotorController as ctrl" ng-init="ctrl.display()">
		...
		<thead>
			<tr class="active">
				<th><button
						...
						<span class="caret"></span>Vehicle Name
					</button></th>
				<th><button
						ng-click="orderByField='productLine';reverseSort = !reverseSort">
						<span class="caret"></span>Catagory
					</button></th>
				<th><button
						ng-click="orderByField='buyPrice';reverseSort = !reverseSort">
						<span class="caret"></span>Cost
					</button></th>
			</tr>
		</thead>
		<tbody>
			<tr
				ng-repeat="m in myWelcome | orderBy:orderByField:reverseSort">

				<td><strong>{{m.productName}}</strong></td>
				<td><strong>{{m.productLine}}</strong></td>
				<td>{{m.buyPrice}}</td>
